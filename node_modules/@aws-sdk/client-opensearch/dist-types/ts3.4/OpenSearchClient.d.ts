...
export type OpenSearchClientConfigType = Partial<
...
export type OpenSearchClientResolvedConfigType =
  __SmithyResolvedConfiguration<__HttpHandlerOptions> &
    ...
    HttpAuthSchemeResolvedConfig &
    ClientResolvedEndpointParameters;
export interface OpenSearchClientResolvedConfig
  extends OpenSearchClientResolvedConfigType {}
export declare class OpenSearchClient extends __Client<
...
> {
  ...
  constructor(
    ...[configuration]: __CheckOptionalClientConfig<OpenSearchClientConfig>
  );
  destroy(): void;
}
