...
export type OpenSearchServerlessClientConfigType = Partial<
...
export type OpenSearchServerlessClientResolvedConfigType =
...
> {
  ...
  constructor(
    ...[
      configuration,
    ]: __CheckOptionalClientConfig<OpenSearchServerlessClientConfig>
  );
  destroy(): void;
}
